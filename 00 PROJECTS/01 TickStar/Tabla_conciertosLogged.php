    ...
    <nav class="navbar  navbar-expand-md navbar/-dark navbar sticky-top" style="background-color: #2E9AFE">
      ...
      <div><img src="<?php echo $f['foto']; ?>" class="config rounded-circle" style="display: inline; margin-top: 5px;" width="30px;" height="30px;"></div>
        <div class="dropdown">
          ...
          <a href="Tabla_conciertosDarkLogged.php"><img src="imagenes/modes/moon-solid.svg" class="mr-2 mt-1" width="30px;" height="30px;"></a>
        </div>
      </div>
    </div>
  </nav>
    ...
    <table class="table table-bordered">
      ...
      ?>
        <tr>
          ...
          <td><a href="precios.php"><center><p> <?php echo $f['descripcion']; ?></center></a></td>
          <td><a href="precios.php"><center><p> <?php echo $f['fecha']; ?></center> </a></td>
          <td><a href="precios.php"><center><p> <?php echo $f['lugar']; ?></center> </a></td>
          <td><a href="precios.php"><center><p> <?php echo $f['hora']; ?></center> </a></td>
        </tr>
        <?php } }?>
      </tbody>
    </table>
