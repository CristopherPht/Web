...
<html lang="en">
    ...
    <nav class="navbar  navbar-expand-md navbar/-dark navbar sticky-top" style="background-color: #2E9AFE">
      ...
      <div><img src="<?php echo $f['foto']; ?>" class="config rounded-circle" style="display: inline; margin-top: 5px;" width="30px;" height="30px;"></div>
        <div class="dropdown">
          ...
          <a href="nosotrosDarkLogged.php"><img src="imagenes/modes/moon-solid.svg" class="mr-2 mt-1" width="30px;" height="30px;"></a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <section class="container">
    ...
    <p class="text-justify p-"><p class="font-weight-bold">Misión</p>Ofrecemos la calidad y servicios necesarios para que el cliente o compradores potenciales, puedan hacer uso de nuestro sitio web. De esta forma, se logra
    interactuar de forma cómoda a cualquier hora y en cualquier lugar.</p>
    <p class="text-justify p-"><p class="font-weight-bold">Visión</p>Ser la primera opción, por encima de nuestra competencia, en cuanto a venta de tickets se refiere, ofreciendo el servicio óptimo para que no existan dificultades 
