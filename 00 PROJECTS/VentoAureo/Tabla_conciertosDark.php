 ...
 <section id="nav bar">
    <nav class="navbar  navbar-expand-md navbar/-dark navbar sticky-top" style="background-color: #32363a">
      ...
      <div class="d-flex flex-row justify-content-center">
        ...
        <a href="Tabla_conciertos.php"><img src="imagenes/modes/sun-solid.svg" width="38px;" height="38px;"></a>
      </div>
    </div>
  </nav>
</section>
<div class="container">
    <div class="shadow-sm p-3 rounded text-uppercase" align="center" style="color: white">Eventos próximos</div>
