  ...
  <section id="nav bar">
    <nav class="navbar  navbar-expand-md navbar/-dark navbar sticky-top" style="background-color: #2E9AFE">
      ...
      <div><img src="<?php echo $f['foto']; ?>" class="config rounded-circle" style="display: inline; margin-top: 5px;" width="30px;" height="30px;"></div>
        <div class="dropdown">
          ...
          <a href="indexDarkLogged.php"><img src="imagenes/modes/moon-solid.svg" class="mr-2 mt-1" width="30px;" height="30px;"></a>
        </div>
      </div>
    </div>
  </nav>
    ...
    <section id="Slider">
        ...
        <div class="col-md-7 container">
          ...
          <div>
            <img class="publicidad5 ml-3 float-left"src="imagenes/publicidad/NZXT.jpg">
          </div>
          <div>
            <img class="publicidad6 mr-3 float-right"src="imagenes/publicidad/HUAWEI.png">
          </div>
    </section>
    <br>
    <!--TEXT ABOUT EVENTS-->
    <div class="shadow-sm p-1 mb-3 bg-white rounded text-uppercase" align="center">Eventos próximos</div>
    <!--CARDS-->
    <section class="container">
      <div class="card-deck">
          <div class="card">
            ...
            <div class="card-body">
            <center><a href="precios.php"><button  type="button" class="btn btn-primary mt-1">Vamos</button></a></center>
            </div>
          </div>
          <div class="card">
