        ...
        <div class="card-deck">
            <div class="card">
                <div class="card-block text-center">
                    <form action="updateImageEvento.php">
                        <p>Imagen: <input type="file" name="foto" value="Subir"></p>
                        <input type="submit" name="hecho" value="Guardar imagen">
                    </form>
                    <form method="post" action="insertarEvento.php" >
                        <p>Descripcion: <input type="text" name="desc"></p>
                        <p>Fecha: <input type="text" name="fecha" ></p>
                        <p>Lugar: <input type="text" name="lugar" ></p>
                        <p>Horario: <input type="text" name="hora"></p>
                        <p>Estatus: <input type="text" name="estatus"></p>
                        <input type="submit" name="hecho" value="Añadir evento">
                    </form>
                </div>
