    ...
    <nav class="navbar  navbar-expand-md navbar/-dark navbar sticky-top" style="background-color: #32363a">
      ...
      <div><img src="<?php echo $f['foto']; ?>" class="config rounded-circle" style="display: inline; margin-top: 5px;" width="30px;" height="30px;"></div>
        <div class="dropdown">
          ...
          <a href="precios.php"><img src="imagenes/modes/sun-solid.svg" class="mr-2 mt-1" width="30px;" height="30px;"></a>
        </div>
      </div>
    </div>
  </nav>
...
<div class="container text-center">
    ...
    ?>
        <div class="card border border-white">
          ...
          <div class="card-body"style="background-color: #32363a;">
            <h5 class="card-title" style="color:white"> <?php  echo $f['nombre']; ?></h5>
            <p class="card-text" style="color:white">El precio que pagarías por ver a tus estrellas favoritas.</p>
            <a href="detallesDark.php?id=<?php echo $f['id'];?>" class="btn btn-light">¡Vamos!</a>
          </div>
        </div>
    <?php
      }
    ...
    ?>
        <div class="card border border-white">
          ...
          <div class="card-body"style="background-color: #32363a;">
            <h5 class="card-title" style="color:white"> <?php  echo $f['nombre']; ?></h5>
            <p class="card-text" style="color:white">El precio que pagarías por una experiencia inolvidable</p>
            <a href="detallesDark.php?id=<?php echo $f['id'];?>" class="btn btn-light">¡Vamos!</a>
          </div>
        </div>
    <?php
   ...
   <br>
    <a href="mapaConciertoDark.php" class="btn btn-light">Ver mapa del escenario</a>
</div>
      <!--FOOTER-->
      <br>
      <br>
